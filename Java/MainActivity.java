package com.example.latihan_intentparcelable;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_move_with_data_activity:
                ...
                moveWithDataIntent.putExtra(Activity_move_with_data.EXTRA_NAME, "Nezarian Saputra");
            ...
            case R.id.btn_move_activity_object:
                ...
                mPerson.setName("Nezarian Saputra");
                mPerson.setAge(17);
                mPerson.setEmail("nezariansaputra6@gmail.com");
            ...
            case R.id.btn_dial_number:
                String phoneNumber = "0895325332971";
